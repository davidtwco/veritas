...
\vspace{2mm}
Within this effort, I'm responsible for providing technical expertise and leadership on the
architecture of the NixOps configuration in the new approach and on the tools and technologies in
use, and in addition, mentoring colleagues and creating internal resources to teach new
technologies, such as Nix, within the infrastructure team. For example, a container-based learning
environment when enables experimentation with NixOS was developed alongside documentation for a
guided introduction. Furthermore, I maintain a handful of internal tools, both for use within the
infrastructure team and in engineering teams. \\
\vspace{2mm}
...
Computing Science Student Intending Single Honours'' and in my fifth year, ``Most Outstanding

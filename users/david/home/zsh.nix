  ...
  programs.zsh = {
    ...
    in
      [
        ...
        { name = "you-should-use"; src = sources.zsh-you-should-use; }
        # Install and keep NVM up-to-date.
        { name = "zsh-nvm"; src = sources.zsh-nvm; }
        # Additional completion definitions.
        { name = "zsh-completions"; src = sources.zsh-completions; }
        ...
        # Git fuzzy commands.
        { name = "forgit"; src = sources.forgit; }
        # Jumping back directories.
        { name = "bd"; src = sources.zsh-bd; }
      ];
    sessionVariables =
      {
